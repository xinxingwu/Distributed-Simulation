...
plt.plot(lamb_num_data[22:30], emp_exp_minus_emp_data[22:30], 'ro', linestyle='-', label='Difference between expected and empirical risk (4)',markersize=size_marker)
...
plt.plot(lamb_num_data[7:15], emp_exp_minus_emp_data[7:15], 'b*', linestyle=':', label='Difference between expected and empirical risk (32)',markersize=size_marker)
# plots an x lable
plt.ylim((4.06, 4.16))
