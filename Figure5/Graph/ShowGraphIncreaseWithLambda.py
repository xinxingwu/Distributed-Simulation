...
plt.plot(lambda_num_lists[0:21], emp_test_minus_emp_data[0:21], 'rs', linestyle='--',
         label='Difference between test error and empirical risk (6,10000)', markersize=size_marker)
plt.plot(lambda_num_lists[21:42], emp_test_minus_emp_data[21:42], 'bo', linestyle=':',
...
plt.annotate(show_value5, xytext=(0.0000955, 0.06875), xy=(0.0001, 0.068534939767174))

show_value6 = str(0.07013)
plt.annotate(show_value6, xytext=(0.0000955, 0.07035), xy=(0.0001, 0.07013542410678936))
