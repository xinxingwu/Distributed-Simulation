...
plt.plot(lamb_num_data[22:30], emp_data[22:30], 'kx', linestyle='-',label='Empirical risk',markersize=size_marker)
plt.plot(lamb_num_data[22:30], emp_exp_data[22:30], 'bo', linestyle='--',label='Expected risk',markersize=size_marker)
plt.plot(lamb_num_data[22:30], emp_exp_minus_emp_data[22:30], 'rs', linestyle=':', label='Difference between expected and empirical risk',markersize=size_marker)
...
#plt.plot(lamb_num_data[7:15], emp_exp_minus_emp_data[7:15], 'bs', linestyle='-', label='The difference between expected and empirical risk (32)')
# plots an x lable
plt.ylim((0.2, 4.8))
...
plt.legend(fontsize=size_font, loc = 'center left')
plt.show()