# coding:utf-8
# This program is used to do experiment on risks/errors change with the amount of working computers
...
tf.app.flags.DEFINE_integer('device_num', 10, 'Number of devices')
...
with tf.Session(server.target) as sess:
    ...
    fo = open("../Data/ComputerIncrease.txt", "a+")
    fo.write(str(lamb) + ",")
